...
async def kurulum_tamamla(
    ...
    conn = None
    try:
        # Şifreleme aracını burada (güvenli alanda) çağırıyoruz
        ...
        # SMTP Şifresini Çift Yönlü Şifrele
        ...
        cursor.execute("""
            ...
            RETURNING id;
        """, (rol_id, smtp_sunucu, smtp_port, smtp_email, kilitli_smtp_sifre, smtp_gonderici, sicil_no))
