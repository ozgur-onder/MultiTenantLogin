document.addEventListener("DOMContentLoaded", function () {
    ...
    function temaUygula(tema) {
        if (tema === "koyu") {
            temaStili.setAttribute("href", "/temalar/kurulum/siyah.css");
            if (temaButonu) temaButonu.innerHTML = gunesIkonu; 
        } else {
            temaStili.setAttribute("href", "/temalar/kurulum/beyaz.css");
            if (temaButonu) temaButonu.innerHTML = ayIkonu; 
        }
